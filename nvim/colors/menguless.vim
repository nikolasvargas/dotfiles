...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    " hi Comment ctermbg=0 ctermfg=7 cterm=NONE guibg=#053230 guifg=#fcc134 gui=NONE
    ...
    hi String ctermbg=0 ctermfg=8 cterm=NONE guibg=#053230 guifg=#fcc134 gui=NONE
