...
" Hide column separating vertically split windows
" added: @nikolasvargas
call s:HL('VertSplit', s:margin_active, s:margin)

" The column that's indicated max chars per line
call s:HL('ColorColumn', s:back, s:back)
...
" ColorColumn that's indicate ErrorMsg
" added: @nikolasvargas
call s:HL('SignColumn', s:special, s:margin)
